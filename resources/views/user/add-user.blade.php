...
@section('title', 'Add User || RMS Panel')
@section('content')
...
<section class="content">
  ...
  <div class="box box-success">
    ...
    <div class="box-header with-border" align="right">
     <button type="submit" class="btn btn-success" id="submit"><i class="fa fa-floppy-o"></i> <b>Save Information</b></button>&nbsp;&nbsp;<a href="{{URL::to('users')}}" class="btn btn-primary"><i class="fa fa-mail-reply"></i> <b>Back</b></a> </div>
    <div class="box-body">
	    <div class="col-md-8">
	    		...
	    		<div class="panel-body">
	    			<div class="form-group">
					    <div class="col-md-6">
					      ...
					      <input type="text" name="name" class="form-control" placeholder="Give your name" required>
					    </div>
					    <div class="col-md-6">
					      <label for="userRole">User Email:</label>
					      <input type="email" name="email" class="form-control" placeholder="somthing@example.com" required>
					    </div>
					</div>
					<div class="form-group">
					    <div class="col-md-6">
					      <label for="userRole">Password:</label>
					      <input type="password" name="password" class="form-control" id="pass1" placeholder="**********" required>
					    </div>
					    <div class="col-md-6">
					      <label for="userRole">Confirm Password:</label>
					      <input type="password" name="confirm_password" class="form-control" id="pass2" placeholder="**********" required>
					...
					<div class="form-group">
					    <div class="col-md-6">
					      ...
					      <input type="text" name="phone_number" class="form-control" placeholder="01***********">
					    </div>
					    <div class="col-md-6">
					...
					<div class="form-group">
					    <div class="col-md-6">
					      ...
					      <input type="text" name="profession" class="form-control" placeholder="Give Your Profession">
					    </div>
					    <div class="col-md-6">
